...
export interface Transaction {
  ...
  merchant?: string; // user-editable merchant/payee label, defaults to the "to" account's name
  edited?: boolean; // true once a user has manually edited category/note/merchant
}
